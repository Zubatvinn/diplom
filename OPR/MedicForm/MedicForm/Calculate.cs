    ...
    public partial class Calculate : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                    ...
                    for (int i = 0; i < parameters.Length; i++)
                    {
                        dbManager.InsertToBD("parameters_value", seria.Value + "," + ids[i] + "," + parameters[i] + ",0," + 3);
                    }
        ...
        private void getValues()
        {
            if (findId())
            {
                ...
                issueList.Text = dbManager.GetValue("issues", "name", "issue_id = " +
                    dbManager.GetValue("calculations_description", "issue_id", "calculation_number = " + seria.Value)).ToString();
            }
            else if (findSeria())
            {
                result.Text = "0";
