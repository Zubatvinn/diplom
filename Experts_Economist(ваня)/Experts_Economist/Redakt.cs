...
namespace Experts_Economist
{
    public partial class Redakt : Form
    {
        ...
        {//переменная для хранения имён формул
            ...
            var obj2 = db.GetRows("formula_parameters", "name_of_parameter", "");
             item = "";
            ...
            var obj3 = db.GetRows("formula_parameters", "id_of_parameter", "");
            item = "";
        ...
        {//переменные для хранения имён формул, описания и id експерта
            ...
            db.InsertToBD("formulas", fields3, values3);//запись новой формулы в БД
            // MessageBox.Show();
            refresh();
        ...
        {//переменная для хранения id формулы
            ...
            db.UpdateRecord("formulas", fields4, values4);//обновляем запись формулы
            // MessageBox.Show();
        ...
        private void add2_Click(object sender, EventArgs e)
        {
            ...
            string[] values4 = { "'" + component_nameTB.Text + "'", "'" + component_measureTB.Text + "'", "'" + component_explTB.Text + "'", "1" };
        ...
        private void update2_Click(object sender, EventArgs e)
        {
            ...
            string[] values5 = { idfc, "'" + component_nameTB.Text + "'", "'" + component_measureTB.Text + "'", "'" + component_explTB.Text + "'", "1" };
        ...
        //событие выбора формулы, при выборе формулы в поля снизу забивается информации по поводу формулы - название, описание, также в списке параметров для формулы отображаются привязанные к формуле параметры
        private void formulasLB_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var obj0 = db.GetRows("formulas", "description_of_formula", "id_of_formula = " + idf);
